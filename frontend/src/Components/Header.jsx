                        ...
                        <div className="d-flex mx-auto flex-column flex-lg-row align-items-center">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                <li className="nav-item active">
                                    <a className="nav-link" href="/">Doccion</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" href="/clinic">Clinica</a>
                                </li>
                                <li className="nav-item">
                            ...
                            <div className="d-flex gap-2 align-items-center">
                                {!isLogged ? (
                                    <>
                                        ...
                                        <button className="btn btn-outline-primary btn-sm px-3" onClick={onClickLogin}>
                                            Ingresar
                                        </button>
                                        <button className="btn btn-primary btn-sm px-3" onClick={onClickRegistro}>
                                            Registrarse
                                        </button>
                                    </>
                                ) : (
                                    <>
                                        ...
                                        <span className="text-muted me-2" style={{fontSize: '14px'}}>¡Hola, Adoptante!</span>
